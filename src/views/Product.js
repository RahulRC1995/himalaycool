            ...
            <Container className='mt-5 ' >
                <Row >
                    ...
                    <Col md="12" className="justify-content-md-center " >
                        ...
                        <p className='mx-3 '>We design execute projects from walk in cold room to big warehouse cold storage as per the requirements of the clients.</p>

                        <h3 className='mt-5'> <img src="snowFlake.svg" class="limg" alt="im" /> INDUSTRIAL COLD ROOMS</h3>
                        <p className='mx-3'>We build industrial coldrooms for various purposes, maintaining the temperature range form 15deg C to 60deg C depending upon the use and products to be stored.</p>
                        ...
                        <p className='mx-3'>We provide total solution in walk in chillers and walk in freezers. The temperature of the cold romm varied from +15C to -30C depending on the products to be stored in each room. The components used in cold rooms to be food safe as per HACCP requirements.</p>
                        <h3 className='mt-5'> <img src="snowFlake.svg" class="limg" alt="im" /> BLAST FREEZERS & CHILLERS</h3>
                        <p className='mx-3'>The concept of blast freezers is to quickly reduce the temperature of food products as fresh produced, in order to reduce the metabolic process significantly. They are often used in the food industries such as ice cream, meat, fish and vegetable products.</p>
